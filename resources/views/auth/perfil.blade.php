                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('actualizar_perfil') }}">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control" name="name" value="{{ Auth::user()->name }}" requiredz autofocus>
                        ...
                        <div class="form-group{{ $errors->has('apellidos') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="lastname" type="text" class="form-control" name="apellidos" value="{{ Auth::user()->apellidos }}" requiredz autofocus>
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control" name="email" value="{{ Auth::user()->email }}" requiredz>
                        ...
                        {{-- <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" type="password" class="form-control" name="password_confirmation" requiredz>
                            </div>
                        </div> --}}
                        ...
                        <div class="form-group{{ $errors->has('birthday') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="birthday" type="date" class="form-control" name="birthday" value="{{ Auth::user()->birthday }}" requiredz>
                        ...
                        <div class="form-group{{ $errors->has('genero') ? ' has-error' : '' }}">
                         ...
                         <div class="form-group{{ $errors->has('pais') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="pais" type="text" class="form-control" name="pais" value="{{ Auth::user()->pais }}" requiredz>
                        ...
                        <div class="form-group{{ $errors->has('estado') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="estado" type="text" class="form-control" name="estado" value="{{ Auth::user()->estado }}" requiredz>
                        ...
                        <div class="form-group{{ $errors->has('ciudad') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="ciudad" type="text" class="form-control" name="ciudad" value="{{ Auth::user()->ciudad }}" requiredz>
                       ...
                       <div class="form-group{{ $errors->has('foto') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="file" class="form-control-file" id="fotoPerfil" value="{{ Auth::user()->foto }}" name="foto" aria-describedby="fileHelp" requiredz>
