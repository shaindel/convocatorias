            ...
            @foreach ($convocatorias as $convocatoria)
                <div class="col-lg-4 centered">
                    <div class="convo-wrapper">
                        ...
                        <img class="" src="/images/convocatorias2017/{{$convocatoria->imagen}}" alt="voluntariado convocatoria" width="250" height="117"/><br><br>
                        <div class="convo-body">
                            <span class="light-weight">{{$convocatoria->intro}} <br></span>
                            <span><b>{{$convocatoria->fecha}}</b></span>
            ...
            <div class="row">
                <div class="col-lg-4 centered">
                    <div class="convo-wrapper-closed">
                        ...
                        <img class="element-closed" src="images/convocatorias2017/induccion.jpg" alt="Generic placeholder image" width="250" height="117" /><br><br>
                        <div class="convo-body">
